...
namespace SampleBackend.Common
{
    ...
    public class EmailNotification
    {
        ...
        public static EmailSetting GetEmailSettingObj(bool EmailEnableSsl, string EmailHostName, string EmailPassword, string EmailAppPassword, int EmailPort, string EmailUsername, string FromEmail, string FromName)
        {
